        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="box box-default color-palette-box">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-graduation-cap"></i> Pendidikan Terakhir</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <form action="<?= base_url('equipt/saveUniv'); ?>" method="post"
                                    class="form-horizontal">
                                    <input type="hidden" name="nis" value="<?= $name->nis ?>">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Alamat Sekolah</label>
                                            <div class="col-sm-9">
                                                <div class="col-xl-4">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Pilih Sekolah</label>
                                            <div class="col-sm-9">
                                                <select id="skl" name="npsn" class="form-control select2" required>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">Sekolah Asal</label>
                                            <div class="col-sm-9">
                                                <div class="col-xl-4">
                                                    <textarea class="form-control" name=""
                                                        readonly><?= $name->npsn . ' - ' . $name->asal . ' - ' . $name->a_asal  ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label">NPSN</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="npsn" id="npsn" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="col-xl-4">
                                                    <textarea class="form-control" name="alamat" id="nama"
                                                        readonly></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="col-xl-4">
                                                    <textarea class="form-control" name="a_asal"
