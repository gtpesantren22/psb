 ...
 <section class="landing-home section-pb-space" id="home">
   <img class="img-fluid bg-img-cover" src="<?= base_url('viho/') ?>assets/images/landing/landing-home/home-bg2.jpg" alt="">
     ...
     <div class="row">
       <div class="col-12">
         <div class="landing-home-contain">
           <div>
             <!-- <div class="landing-logo"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/landing/landing-home/logo.png" alt=""></div> -->
             <h6>pendaftaran santri baru </h6>
             <h2>PonPes <span>Darul Lughah Wal Karomah</span></h2>
             <p>Jl. Mayjend Pandjaitan No. 12, Sidomukti-Kraksaan-Probolinggo <br> Tahun Pelajaran 2024/2025 </p><a class="btn-landing btn-lg" href="<?= base_url('daftar') ?>">Daftar Sekarang</a>
           </div>
         </div>
       </div>
     </div>
   ...
   <div class="position-block">
     ...
     <ul class="animat-block">
       <li>
         <div>
           <img class="img-fluid img5" src="<?= base_url('') ?>assets/img/logo/Logo_Pesantren.png" alt="">
           <img class="img-fluid img5" src="" alt="">
           <img class="img-fluid img5" src="" alt="">
           <img class="img-fluid img5" src="" alt="">
         </div>
       </li>
 ...
 <!--demo section start-->
 <section class="demo-section section-py-space" id="gelombang">
   <div class="title">
       ...
       <div class="col-lg-4 col-sm-6">
         <div class="demo-box">
           <div class="ribbon-wrapper card">
             <div class="card-body">
               <div class="ribbon ribbon-clip ribbon-success">Gelombang 1</div>
               <h6 class="mt-3 f-14 f-w-600">31 Oktober 2023 s/d 14 Desember 2023 </h6>
               <h6 class="mt-3 f-14 f-w-800 text-success">Biaya Pendaftaran : <?= rupiah(80000) ?></h6>
             </div>
           </div>
 ...
 <!--demo section end-->
 <!--frameworks start-->
 <section class="framework section-py-space light-bg" id="persyaratan">
   <div class="custom-container">
     <div class="row">
       <div class="col-sm-12 wow pulse">
         <div class="title">
           <h2>Persyaratan dan Jalur Pendaftaran </h2>
         </div>
                 ...
                 <div class="card">
                   ...
                   <div class="card-body">
                     <ul class="list-group">
                       ...
                       <li class=""><i class="fa fa-check text-success"></i> Fotocopy <strong>KTP Orang Tua Kandung (Bapak & Ibu)</strong> 4 Lembar</li>
                       <li class=""><i class="fa fa-check text-success"></i> Fotocopy <strong>Kartu KIP</strong> (bagi yang memiliki)</li>
                     </ul>
                   </div>
                 </div>
               </div>
               ...
               <div class="col-xl-12">
                 <div class="card">
                   <div class="card-header">
                     <h5 class="p-0">
                       <button class="btn btn-link ps-0" data-bs-toggle="collapse" data-bs-target="#collapseicon2" aria-expanded="true" aria-controls="collapseicon2">Petunjuk Pengisian</button>
                     </h5>
                   </div>
                     ...
                     <div class="card-body post-about">
                       <ul>
                         <li>
                           ...
                           <div>
                             <h5>Mengisi Form Pendaftaran</h5>
                             <p>Calon santri mengisi formulir pendaftaran dengan benar susai ketentuan yang ada. <a href="https://psb.ppdwk.com/daftar">kilk disini!</a></p>
                           </div>
                         </li>
                         <li>
                           <div class="icon"><i data-feather="message-circle"></i></div>
                           <div>
                             <h5>Informasi WhatsApp</h5>
                             <p>Calon santri akan mendapatkan informasi melalui no WhatsApp yang masukan ketika menngisi formulir pendaftaran</p>
                           </div>
                         </li>
                         <li>
                           ...
                           <div>
                             ...
                             <p>calon santri melakukan pembayaran pendaftaran berdasarkan informasi yang dikirimkan oleh panitia</p>
                           </div>
                         </li>
                         <li>
                           <div class="icon"><i data-feather="log-in"></i></div>
                           <div>
                             <h5>LogIn Akun Santri</h5>
                             <p>Calon santri melakukan login di apilikasi PSB <a href="https://psb.ppdwk.com/login">(Login disini)</a> menggunakan akun yang didapatkan dari informasi WhatsApp yang didapatkan</p>
                           </div>
                         </li>
                         <li>
                           <div class="icon"><i data-feather="user-check"></i></div>
                           <div>
                             <h5>Melengkapi Biodata Santri</h5>
                             <p>Calon santri melengkapi semua biodata yang diperlukan meliputi biodata diri, orang tua, asal sekola, dan upload berkas-berkas persyaratan</p>
                           </div>
                         </li>
                       </ul>
                     </div>
     ...
     <div class="row">
       <div class="col-12">
         <div class="owl-carousel owl-theme" id="owl-carousel-2">
           <div class="item">
             <div class="pages-box"><a href="#" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/MADIN-DWK.png" alt=""></div>
           ...
           <div class="item">
             <div class="pages-box"><a href="#" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/ra.png" alt=""></div>
                 <div class="page-detail">
                   <h3>RA DWK</h3>
                 </div>
               </a></div>
           ...
           <div class="item">
             <div class="pages-box"><a href="#" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/LOGO-MI.png" alt=""></div>
                 <div class="page-detail">
                   <h3>MI DWK</h3>
                 </div>
               </a></div>
           ...
           <div class="item">
             <div class="pages-box"><a href="#" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/MTS-DWK.png" alt=""></div>
                 <div class="page-detail">
                   <h3>MTs DWK</h3>
                 </div>
               </a></div>
           ...
           <div class="item">
             <div class="pages-box"><a href="#" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/SMP-DWK.png" alt=""></div>
                 <div class="page-detail">
                   <h3>SMP DWK</h3>
                 </div>
               </a></div>
           ...
           <div class="item">
             <div class="pages-box"><a href="#" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/logo-ma.png" alt=""></div>
                 <div class="page-detail">
                   <h3>MA DWK</h3>
                 </div>
               </a></div>
           ...
           <div class="item">
             <div class="pages-box"><a href="https://smk-dwk.sch.id/" target="blank">
                 <div class="img-wrraper"><img class="img-fluid" src="<?= base_url('viho/') ?>assets/images/logos/SMK-DWK.jpg" alt=""></div>
                 <div class="page-detail">
                   <h3>SMK DWK</h3>
                 </div>
               </a></div>
           ...
           <div class="card-body">
             <ul class="list-group">
               <?php foreach ($down as $dw) : ?>
                 <li class="list-group-item d-flex justify-content-between align-items-center"><a href="<?= base_url('welcome/unduh/' . $dw->id_download) ?>"><i class="fa fa-download"></i><?= $dw->nama ?></a><span class="badge badge-primary counter"><?= $dw->jumlah ?></span></li>
               <?php endforeach; ?>
             </ul>
           </div>
         </div>
     ...
     <div class="row">
       <div class="col-12">
         <div class="footer-contain">
           ...
           <h2>Informasi lebih lanjut, Hub Kami</h2>
           <h3>Humas Pesantren : 0852 3422 3306</h3>
           <h3>Pelayanan : 0877 5565 6074</h3>
           <p>Via WhatsApp/Telepon</p>
           <ul class="star-rate">
