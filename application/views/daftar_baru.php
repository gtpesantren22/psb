                ...
                <div class="card-body">
                    <div class="col-12 animated bounceIn">
                        ...
                        <ol>
                            ...
                            <li>Untuk Pengisian Semua kolom, diharapkan mengisi <b><u>berdasarkan data di Kartu Keluarga (KK)</u></b></li>
                            <li>Khusus Pendaftar MI dan RA itu tidak tinggal di Pesantren</li>
                            <li class="text-danger"><b><i>Untuk No. WA harap diisi dengan No. WA aktif, Karena semua informasi akan dikirimkan kepada No yang didaftarkan</i></b></li>
                            <li class="text-danger">Setalah melakukan pendaftaran, akan mendapatkan informasi berupa pesan WA, harap untuk mengikuti pesan tersebut</li>
                        </ol>
