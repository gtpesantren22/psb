...
<head>
  ...
  <meta name="author" content="Tim IT PPDWK">
...
<body>
      ...
      <div class="comingsoon">
        <div class="comingsoon-inner text-center"><a href="#"><img src="<?= base_url('viho/') ?>assets/images/logo/logo-psb.png" height="100" alt=""></a>
          ...
          <div class="countdown" id="clockdiv">
            <ul>
              <li><span class="time digits" id="days"></span><span class="title">Hari</span></li>
              <li><span class="time digits" id="hours"></span><span class="title">Jam</span></li>
              <li><span class="time digits" id="minutes"></span><span class="title">Menit</span></li>
              <li><span class="time digits" id="seconds"></span><span class="title">Detik</span></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <!-- Plugins JS start-->
  <script src="<?= base_url('viho/') ?>assets/js/countdown.js"></script>
  <!-- Plugins JS Ends-->
  <!-- Theme js-->
